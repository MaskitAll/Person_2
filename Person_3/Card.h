...
public:
	...
	std::string character_to_printstring(Character character);		//ѕеревод характеристики к печатному виду стринг

	int h_to_12(std::string str, bool h);							//¬спомогатльна€ функци€
